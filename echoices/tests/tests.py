...
from echoices.tests.models import (
    ETestCharOrderedChoices,
    ETestStrOrderedChoices,
    ETestIntOrderedChoices,
)
...
from echoices.tests.models import (
    TestCharChoicesDefaultModel,
    TestStrChoicesDefaultModel,
    TestIntChoicesDefaultModel,
)
from echoices.tests.models import (
    TestCharChoicesModel,
    TestStrChoicesModel,
    TestIntChoicesModel,
)
from echoices.tests.models import (
    TestCharOrderedChoicesModel,
    TestStrOrderedChoicesModel,
    TestIntOrderedChoicesModel,
)
...
from echoices.tests.models import (
    TestEChoiceFieldEFloatChoicesModel,
    TestEChoiceFieldDefaultEFloatChoicesModel,
)
from echoices.tests.models import (
    TestEChoiceFieldEIntChoicesModel,
    TestEChoiceFieldDefaultEIntChoicesModel,
)
from echoices.tests.models import (
    TestEChoiceFieldEStrChoicesModel,
    TestEChoiceFieldDefaultEStrChoicesModel,
)
...
from ..tests.models import (
    TestEChoiceCharFieldEStrOrderedChoicesSortedModel,
...
class EChoiceTest(TestCase):
    ...
    def test_choices(self):
        self.assertEqual(
            ETestCharChoices.choices(), (("u", "Label 1"), ("v", "Label 2"))
        )
        self.assertEqual(
            ETestStrChoices.choices(), (("value1", "Label 1"), ("value2", "Label 2"))
        )
        self.assertEqual(ETestIntChoices.choices(), ((10, "Label 1"), (20, "Label 2")))
        self.assertEqual(
            ETestFloatChoices.choices(), ((1.0, "Label 1"), (2.0, "Label 2"))
        )
        self.assertEqual(
            ETestBoolChoices.choices(), ((True, "Label 1"), (False, "Label 2"))
        )
    ...
    def test_call(self):
        ...
        self.assertEqual(ETestCharChoices.FIELD1("label"), "Label 1")
        self.assertEqual(
            ETestCharChoices.FIELD1("__str__"), str(ETestCharChoices.FIELD1)
        )
    ...
    def test_hashable(self):
        ...
        self.assertEqual(
            hash(ETestCharOrderedChoices.FIELD1), hash(ETestCharOrderedChoices.FIELD1)
        )
        self.assertEqual(
            hash(ETestIntOrderedChoices.FIELD1), hash(ETestIntOrderedChoices.FIELD1)
        )
...
class EOrderedChoiceTest(TestCase):
    ...
    def test_values(self):
        ...
        self.assertEqual(
            ETestStrOrderedChoices.values(), ("value3", "value1", "value2")
        )
    ...
    def test_fromvalue(self):
        self.assertIs(
            ETestCharOrderedChoices.from_value("v"), ETestCharOrderedChoices.FIELD3
        )
        self.assertIs(
            ETestStrOrderedChoices.from_value("value2"), ETestStrOrderedChoices.FIELD3
        )
        self.assertIs(
            ETestIntOrderedChoices.from_value(20), ETestIntOrderedChoices.FIELD3
        )

    def test_choices(self):
        self.assertEqual(
            ETestCharOrderedChoices.choices(),
            (("w", "Label 1"), ("u", "Label 2"), ("v", "Label 3")),
        )
        self.assertEqual(
            ETestCharOrderedChoices.choices("sorted"),
            (("u", "Label 2"), ("v", "Label 3"), ("w", "Label 1")),
        )
        self.assertEqual(
            ETestCharOrderedChoices.choices("reverse"),
            (("w", "Label 1"), ("v", "Label 3"), ("u", "Label 2")),
        )
        self.assertEqual(
            ETestCharOrderedChoices.choices("natural"),
            ETestCharOrderedChoices.choices(),
        )
        self.assertRaises(AssertionError, ETestCharOrderedChoices.choices, "foobar")

        self.assertEqual(
            ETestStrOrderedChoices.choices(),
            (("value3", "Label 1"), ("value1", "Label 2"), ("value2", "Label 3")),
        )
        self.assertEqual(
            ETestStrOrderedChoices.choices("sorted"),
            (("value1", "Label 2"), ("value2", "Label 3"), ("value3", "Label 1")),
        )
        self.assertEqual(
            ETestStrOrderedChoices.choices("reverse"),
            (("value3", "Label 1"), ("value2", "Label 3"), ("value1", "Label 2")),
        )
        self.assertEqual(
            ETestStrOrderedChoices.choices("natural"),
            (("value3", "Label 1"), ("value1", "Label 2"), ("value2", "Label 3")),
        )
        self.assertEqual(
            ETestStrOrderedChoices.choices("natural"), ETestStrOrderedChoices.choices()
        )
        self.assertRaises(AssertionError, ETestCharOrderedChoices.choices, "foobar")

        self.assertEqual(
            ETestIntOrderedChoices.choices(),
            ((30, "Label 1"), (10, "Label 2"), (20, "Label 3")),
        )
        self.assertEqual(
            ETestIntOrderedChoices.choices("sorted"),
            ((10, "Label 2"), (20, "Label 3"), (30, "Label 1")),
        )
        self.assertEqual(
            ETestIntOrderedChoices.choices("reverse"),
            ((30, "Label 1"), (20, "Label 3"), (10, "Label 2")),
        )
        self.assertEqual(
            ETestIntOrderedChoices.choices("natural"),
            ((30, "Label 1"), (10, "Label 2"), (20, "Label 3")),
        )
        self.assertEqual(
            ETestIntOrderedChoices.choices("natural"), ETestIntOrderedChoices.choices()
        )
        self.assertRaises(AssertionError, ETestIntOrderedChoices.choices, "foobar")

    def test_getitem(self):
        self.assertEqual(
            ETestCharOrderedChoices.__getitem__("u"), ETestCharOrderedChoices.FIELD2
        )
...
class EAutoChoiceTest(TestCase):
    ...
    def test_choices(self):
        self.assertEqual(
            ETestAutoChoices.choices(), ((1, "Label 1"), (2, "Label 2"), (3, "Label 3"))
        )
        self.assertEqual(
            ETestAutoChoices.choices("sorted"),
            ((1, "Label 1"), (2, "Label 2"), (3, "Label 3")),
        )
        self.assertEqual(
            ETestAutoChoices.choices("reverse"),
            ((3, "Label 3"), (2, "Label 2"), (1, "Label 1")),
        )
        self.assertEqual(
            ETestAutoChoices.choices("natural"),
            ((1, "Label 1"), (2, "Label 2"), (3, "Label 3")),
        )
        self.assertEqual(
            ETestAutoChoices.choices("natural"), ETestAutoChoices.choices()
        )
...
class ChoiceCharFieldTest(TestCase):
    ...
    def test_create_instance(self):
        instance = TestEChoiceFieldEStrChoicesModel.objects.create(
            choice=ETestStrChoices.FIELD1
        )
        ...
        if StrictVersion(django_version()) < StrictVersion("1.9.0"):
            self.assertEqual(
                instance._meta.fields[1].__class__.__name__, "EChoiceField"
            )
        else:
            self.assertEqual(
                instance._meta.fields[1].__class__.__name__, "ETestStrChoicesField"
            )
        ...
        self.assertRaisesMessage(
            ...
            instance._meta.fields[1].to_python,
            "foo",
        )
        # Custom flatchoices
        self.assertEqual(
            instance._meta.fields[1].flatchoices,
            [(ETestStrChoices.FIELD1, "Label 1"), (ETestStrChoices.FIELD2, "Label 2")],
        )
        instance.delete()

    def test_create_instance_named(self):
        instance = TestNamedEChoiceFieldEStrChoicesModel.objects.create(
            choice=ETestStrChoices.FIELD1
        )
        choice = instance.choice
        self.assertIsInstance(choice, ETestStrChoices)
        ...
        if StrictVersion(django_version()) < StrictVersion("1.9.0"):
            ...
            self.assertEqual(
                instance._meta.fields[1].__class__.__name__, "MyEnumFieldName"
            )
        self.assertEqual(instance._meta.fields[1].choices, ETestStrChoices.choices())
        self.assertIs(instance._meta.fields[1].default, models.fields.NOT_PROVIDED)
        self.assertEqual(instance._meta.fields[1].get_default(), "")
...
class ChoiceIntFieldTest(TestCase):
    ...
    def validate_instance(self, instance):
        ...
        if StrictVersion(django_version()) < StrictVersion("1.9.0"):
            ...
            self.assertEqual(
                instance._meta.fields[1].__class__.__name__, "ETestIntChoicesField"
            )
    ...
    def test_create_instance(self):
        instance = TestEChoiceFieldEIntChoicesModel.objects.create(
            choice=ETestIntChoices.FIELD1
        )
        # import pdb
        # pdb.set_trace()
...
class ChoiceFloatFieldTest(TestCase):
    ...
    def validate_instance(self, instance):
        ...
        self.assertEqual(
            instance._meta.fields[1].flatchoices,
            [
                (ETestFloatChoices.FIELD1, "Label 1"),
                (ETestFloatChoices.FIELD2, "Label 2"),
            ],
        )
    ...
    def test_create_instance(self):
        instance = TestEChoiceFieldEFloatChoicesModel.objects.create(
            choice=ETestFloatChoices.FIELD1
        )
        self.validate_instance(instance)
        instance.delete()
...
class ChoiceBoolFieldTest(TestCase):
    ...
    def test_create_instance(self):
        instance = TestEChoiceFieldDefaultEBoolChoicesModel.objects.create(
            choice=ETestBoolChoices.FIELD1
        )
        choice = instance.choice
        ...
        if StrictVersion(django_version()) < StrictVersion("1.9.0"):
            ...
            self.assertEqual(
                instance._meta.fields[1].__class__.__name__, "ETestBoolChoicesField"
            )
        ...
        self.assertEqual(
            instance._meta.fields[1].flatchoices,
            [
                (ETestBoolChoices.FIELD1, "Label 1"),
                (ETestBoolChoices.FIELD2, "Label 2"),
            ],
        )
        instance.delete()
        ...
        def create():
            ...
            class TestEChoiceFieldEComplexChoicesModel(models.Model):
                ...
                choice = make_echoicefield(
                    ETestComplexChoices, default=ETestComplexChoices.FIELD1
                )
    ...
    def test_create_empty_instance(self):
        def create():
            ...
            class TestEChoiceFieldMixedDefaultModel(models.Model):
                ...
                choice = make_echoicefield(
                    ETestCharChoices, default=ETestIntChoices.FIELD1
                )
...
class OrderedChoiceCharFieldTest(TestCase):
    ...
    def test_create_instance(self):
        instance = TestEChoiceCharFieldEStrOrderedChoicesModel.objects.create(
        ...
        if StrictVersion(django_version()) < StrictVersion("1.9.0"):
            ...
            self.assertEqual(
                instance._meta.fields[1].__class__.__name__,
                "ETestStrOrderedChoicesField",
            )
        self.assertEqual(
            instance._meta.fields[1].choices, ETestStrOrderedChoices.choices()
        )
        self.assertIs(
            instance._meta.fields[1].default, ETestStrOrderedChoices.FIELD1.value
        )
        self.assertIs(
            instance._meta.fields[1].get_default(), ETestStrOrderedChoices.FIELD1
        )
        instance.delete()
...
class AdminTest(TestCase):
    ...
    def test_admin_testcharchoicesmodel_list(self):
        ...
        for param in ["", "?choice__exact=u"]:
            ...
            self.assertInHTML(
                '<p class="paginator">1 test char choices model</p>',
    ...
    def test_admin_testcharchoicesmodel_change(self):
        ...
        response = self.client.get(
            "/admin/tests/testcharchoicesmodel/1/change/", follow=True
        )
        self.assertEqual(response.status_code, 200)
        self.assertInHTML(
            '<option value="u" selected="selected">Label 1</option>',
            response.rendered_content,
        )
...
class FormTest(TestCase):
    ...
    def test_modelform_testechoicefieldestrchoicesmodel(self):
        ...
        self.assertInHTML(
            '<option value="value1" selected="selected">Label 1</option>', str(f)
        )
